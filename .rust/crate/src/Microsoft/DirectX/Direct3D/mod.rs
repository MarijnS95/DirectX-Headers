...
impl ID3DBlob {
    pub unsafe fn GetBufferPointer(&self) -> *mut ::core::ffi::c_void {
        (::windows::core::Vtable::vtable(self).GetBufferPointer)(::windows::core::Vtable::as_raw(
            self,
        ))
    }
...
impl ID3DDestructionNotifier {
    pub unsafe fn RegisterDestructionCallback(
        ...
        (::windows::core::Vtable::vtable(self).RegisterDestructionCallback)(
    ...
    pub unsafe fn UnregisterDestructionCallback(
        ...
        (::windows::core::Vtable::vtable(self).UnregisterDestructionCallback)(
            ::windows::core::Vtable::as_raw(self),
            callbackid,
        )
        .ok()
...
impl ID3DInclude {
    ...
    {
        (::windows::core::Vtable::vtable(self).Open)(
            ::windows::core::Vtable::as_raw(self),
            includetype,
            pfilename.into().abi(),
            pparentdata,
    ...
    pub unsafe fn Close(&self, pdata: *const ::core::ffi::c_void) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).Close)(::windows::core::Vtable::as_raw(self), pdata)
            .ok()
    }
}
