...
pub trait ID3D12DSRDeviceFactory_Impl: Sized {
    fn CreateDSRDevice(
        &self,
        pd3d12device: ::core::option::Option<&ID3D12Device>,
        nodemask: u32,
        riid: *const ::windows::core::GUID,
        ppvdsrdevice: *mut *mut ::core::ffi::c_void,
    ) -> ::windows::core::Result<()>;
}
impl ::windows::core::RuntimeName for ID3D12DSRDeviceFactory {}
impl ID3D12DSRDeviceFactory_Vtbl {
    ...
    >() -> ID3D12DSRDeviceFactory_Vtbl {
        unsafe extern "system" fn CreateDSRDevice<
            Identity: ::windows::core::IUnknownImpl<Impl = Impl>,
            Impl: ID3D12DSRDeviceFactory_Impl,
            const OFFSET: isize,
        >(
            ...
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
            this.CreateDSRDevice(
                ::windows::core::from_raw_borrowed(&pd3d12device),
                ::core::mem::transmute_copy(&nodemask),
                ::core::mem::transmute_copy(&riid),
                ::core::mem::transmute_copy(&ppvdsrdevice),
            )
            .into()
        }
        Self {
    ...
    pub fn matches(iid: &windows::core::GUID) -> bool {
        iid == &<ID3D12DSRDeviceFactory as ::windows::core::ComInterface>::IID
    }
}
